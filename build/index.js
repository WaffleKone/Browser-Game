...
const dictionary_js_1 = require("./dictionary.js"); // pulls our dictionary from the dictionary.js file
...
let gameState = {
    playerScore: 0,
    hiScore: 0,
    newWords: dictionary_js_1.dictionary,
    currentWord: '',
    lastWord: '',
...
function gameOver() {
    ...
    newGameButton.addEventListener('click', function () {
        ...
        seenWords = [];
        gameState.newWords = dictionary_js_1.dictionary;
        let clickAudio = new Audio('./assets/clickEffect.mp3');
        clickAudio.volume = 0.2;
        clickAudio.play();
        createGame();
